...
var app = (function () {
    ...
    /* src\Component.svelte generated by Svelte v3.45.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p0 = element("p");
    			t0 = text("Brought to you by the ");
    			t1 = text(/*title*/ ctx[0]);
    			t2 = space();
    			p1 = element("p");
    			p1.textContent = `${/*name*/ ctx[1]}`;
    			t4 = space();
    			img = element("img");
    			attr_dev(p0, "class", "p1 svelte-np92sh");
    ...
    class Component extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*title*/ ctx[0] === undefined && !('title' in props)) {
    			console.warn("<Component> was created without expected prop 'title'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "My first svelte app";
    			t1 = space();
    			create_component(component.$$.fragment);
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file, 7, 1, 93);
